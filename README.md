...
0.9.0 的 19 组回归、33,947 项检查通过，新增挂接层级与 GLB/FBX 独立回读、外挂绘制遮挡、统一涂装依赖、工程组合恢复、UTF-8/CP1251 字符串检查。真实 F-15E、LAU-88、AGM-65D、AIM-120C 组合已完成预览、GPU 求值和外挂绘制验证，细节见[验证记录](docs/NATIVE_VALIDATION.md)。
