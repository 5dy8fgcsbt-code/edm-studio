...
0.9.1 的 21 组回归、34,834 项检查通过，包含挂接层级、GLB/FBX 独立回读、外挂绘制遮挡、统一涂装依赖、工程组合恢复，以及卸载和画布历史重映射。真实 F-15E、LAU-88、AGM-65D、AIM-120C 组合已完成点击弹出按钮、按按钮卸载、保留涂装和工程重开验证，细节见[验证记录](docs/NATIVE_VALIDATION.md)。
